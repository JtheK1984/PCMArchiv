...
begin
  ...
  begin
    ...
    frm_pcm_main.ppmbtn_Benutzer.Visible:= false;
    frm_pcm_main.ppmbtn_Konfiguration.Visible:= false;
    frm_pcm_main.ppmbtn_Design.Visible:= false;
  end;
  ...
  1,2,3:
    begin
      ...
      frm_pcm_main.ppmbtn_Benutzer.Visible:= true;
    end;
  end;
  ...
  1,2,3:
    begin
      ...
      frm_pcm_main.ppmbtn_Konfiguration.Visible:= true;
    end;
  end;
  ...
  0:
    begin
      frm_pcm_main.iDesign.Visible:= false;
      frm_pcm_main.ppmbtn_Design.Visible:= false;
    end;
  1,2,3:
    begin
      frm_pcm_main.navbrgrp_Optionen.Visible:= true;
      frm_pcm_main.iDesign.Visible:= true;
      frm_pcm_main.ppmbtn_Design.Visible:= true;
    end;
  end;
  ...
  0:
    begin
      frm_pcm_main.navbrgrp_Kontake.Visible:= false;
      frm_pcm_main.ppmbtn_Archiv.Visible:= false;
    end;
  1,2,3:
    begin
      frm_pcm_main.navbrgrp_Kontake.Visible:= true;
      frm_pcm_main.ppmbtn_Archiv.Visible:= true;
    end;
  end;
  Application.ProcessMessages;
